...
int main(void)
{
	...
	si_other.sin6_addr.s6_addr[2] = 0;
	si_other.sin6_addr.s6_addr[3] = 0;
	...
	si_other.sin6_addr.s6_addr[9] = 0;
	si_other.sin6_addr.s6_addr[10] = 0;
	si_other.sin6_addr.s6_addr[11] = 0;
	si_other.sin6_addr.s6_addr[12] = 0;
	si_other.sin6_addr.s6_addr[13] = 0;
	si_other.sin6_addr.s6_addr[14] = 0;
